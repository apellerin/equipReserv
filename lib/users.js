...
updatePassword = function(req, res){
    ...
    async.waterfall([
        ...
        function(connection, callback){
            var sql = "SELECT user_name, first_name, last_name, email, phone, CASE WHEN user_level = -1 THEN 'Admin' ELSE 'User' END AS type, \
                        CASE WHEN ACTIVATED = 0 THEN 'No' ELSE 'Yes' END AS activated, modified, last_login\
                        FROM users \
