...
exports.adminUpdate = function (req, res) {
    ...
    getByHash(req.session.thisUser.hash, function (user) {
        sql = 'UPDATE users SET user_level = ?, activated = ?, modified = NOW() WHERE user_id = ?';

        inserts = [req.body.user_level, req.body.activated, req.body.user_id];
        ...
        async.waterfall([
            ...
            function (results) {
                //Add code to return success/failure results
            }
        ], function (err, result) {
