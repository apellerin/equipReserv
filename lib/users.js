...
var sendActivationLink = function(hash, email){
        var dataobj = {
            content : mail_props.user_activation_email.text + mail_props.user_activation_email.link + hash,
            heading : 'Welcome!' 
        };
    ...
    async.waterfall([
                   //Acquire SQL connection from pool
                    ...
                    function(hash){
                        ...
                        var html = null;
                        mail.sendEmail(text, html, email, mail_props.reset_password_email.subject);
