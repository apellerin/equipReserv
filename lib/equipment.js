...
exports.getEquipStatus = function(column, value, cb){
    async.waterfall([
        ...
        //Prepare and execute SQL
        function(connection, callback){
            var sql = 'SELECT * FROM item_status WHERE ?? = ?';
...
/*exports.viewInventory = function(equip_id, length, page, filter, cb){
    async.waterfall([
        //Acquire SQL connection from pool
        function(callback){
            sql_pool.acquire(function(err, connection){
        ...
        function(connection, callback){
            var sql = "SELECT b.make, b.model, a.inventory_id, c.status_desc \
                        ...
                        INNER JOIN equip_status c ON a.item_status = c.status_id \
